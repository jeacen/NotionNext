...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    ...
    '1bf6041f23764a3b8995c4504a3b5f3c,en:1bf6041f23764a3b8995c4504a3b5f3c',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'ichaintalk.com', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '学无止境，财随智增🎉', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://ichaintalk.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, ichaintalk, 挖矿, 区块链, 矿工, 矿池, 虚拟货币, 比特币', // 网站关键词 英文逗号隔开
