const CONFIG = {
  ...
  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '挖矿学院', url: '/tag/挖矿学院' },
  HEO_HERO_CATEGORY_2: { title: '云计算学院', url: '/tag/云计算学院' },
  HEO_HERO_CATEGORY_3: { title: '精彩分享', url: '/tag/精彩分享' },
  ...
  HEO_SOCIAL_CARD_URL: 'https://discord.gg/9AJfycX3',
